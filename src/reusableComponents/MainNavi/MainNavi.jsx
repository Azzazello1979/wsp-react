...
const HorizontalNavi = (props) => {
    ...
    return (
        <React.Fragment>
            <NavLink to="/login" className={classes['main-navi-anchor']} activeClassName={classes.active}><Button variant="contained" color="primary" style={buttonStyle}>Login</Button></NavLink>
